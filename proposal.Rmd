...
How these datasets are used and data processing will be further explained in the next section below.
...
The Participant dataset will be used for this visualization. No further processing of the dataset is needed.
...
This visualization aims to show how cost of rental and other facilities differ across the city. Two hexagonal binning maps will be displayed next to each other. The visualization on the left will use the average rental cost per occupant per building as the event points. The second visualization on the right will show the facilities with their associated costs as the event points (e.g. For Restaurants, foodCost will be used). A radio button will list the different choice of facilities to display, namely Schools, Restaurants and Pubs. A skeletal grey outline of the hexes representing the different blocks will be beneficial for the user to identify the location of the facilities.
