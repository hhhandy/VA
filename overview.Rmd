...
This project aims to provide an interactive web-enabled visualizations to allow users to identify the life patterns of Engagement City, Ohio USA in a single dashboard.
...
The following are R packages required for this project.

::: l-body
| Packages | Purpose |
|----------|---------|
| shiny | To build interactive web application and visualizations |
