...
This project aims to provide an interactive web-enabled visualizations to allow users to identify the life patterns in Engagement City, Ohio USA in a single dashboard.
